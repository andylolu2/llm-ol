...
For inference, we use the vLLM \cite{kwon2023efficient} server with a throughput of $\approx 10$ documents per second. Inference on the validation and test splits of both datasets takes 12 A100-hours.
